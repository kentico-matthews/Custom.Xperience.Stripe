...
In this case, you'll first need to open each project and restore nuget packages, and rebuild.

Then, add the live site and admin class library projects from the repository to the appropriate solutions in Visual Studio. Do the following for each of the two projects:
